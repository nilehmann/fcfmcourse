\documentclass[usedate]{dcccourse}
...
\professor[ahevia@dcc.uchile.cl]{Alejandro Hevia}
%\professor[gnavarro@dcc.uchile.cl]{Gonzalo Navarro}
\assistant[nlehmann@dcc.uchile.cl]{Nicolás Lehmann}
\assistant[jgarrido@dcc.uchile.cl]{José Garrido}
% Si pasas el comando usedate a la clase, la fecha aparecerá bajo la lista de auxiliares
% puedes usar el formato de la fecha por defecto de latex (y traducirla usando babel)
